Rails.application.configure do
  ...
  # config.action_cable.allowed_request_origins = [ 'https://codeplug0.herokuapp.com/', 'http://codeplug.co', 'http://codeplug.co']
  ...
  # config.active_job.queue_name_prefix = "CODE_PLUG_#{Rails.env}"
